...
package org.purepdf.pdf
{
	...
	public class ArabicLigaturizer
	{
		...
		private static const chartable: Vector.<Vector.<int>> = Vector.<Vector.<int>>([
			...
			Vector.<int>([0x067C, 0x067C,0xE10F,0xE110,0xE111]),
			...
			Vector.<int>([0x0681, 0x0681,0xE113,0xE114,0xE115]),
			Vector.<int>([0x0683, 0xFB76, 0xFB77, 0xFB78, 0xFB79]),
			Vector.<int>([0x0684, 0xFB72, 0xFB73, 0xFB74, 0xFB75]),
			Vector.<int>([0x0685, 0x0685,0xE10C,0xE10D,0xE10E]),
			...
			Vector.<int>([0x0689, 0x0689,0xE103]),
			...
			Vector.<int>([0x0693, 0x0693,0xE108]),
			Vector.<int>([0x0696, 0x0696,0xE104]),
			Vector.<int>([0x0698, 0xFB8A, 0xFB8B]),
			Vector.<int>([0x069A, 0x069A, 0xE109, 0xE10A, 0xE10B]),
			...
			Vector.<int>([0x06AB, 0x06AB, 0xE11D, 0xE11E, 0xE11F]),
			...
			Vector.<int>([0x06BC, 0x06BC, 0xE105, 0xE106, 0xE107]),
		...
		private static function shapecount( s: int ): int
		{
			...
			if ((s >= 0x0621) && (s <= 0x06FF) && !isVowel(s)) {
				l = 0;
